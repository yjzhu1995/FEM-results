...
xin2=/home1/yzhu/xin_code/2term/Haida_Gwaii_3layer_E8km_H100kmM5e16_M1e20/disp/
xin3=/home1/yzhu/xin_code/2term/Haida_Gwaii_3layer_E10km_H400kmM4e17_M1e20/disp/
arrow1=0.2c+ea+h0.25+p1.5p,blue+n30 #0.2c represent arrow length
...
gmt begin Quicklook_best png A+m0.5c
	...
	gmt subplot begin 3x3 -Fs5i/2i -M0.3c/0.3c -A+o0.2c/3c
		gmt subplot set 0,0 -A'Mapview of HG'
			...
			awk '{print $3,$2,$6,$5,$8,$7,0,$1}' $gps | gmt velo   -JM7i -R$R -Se0.05c/0.95/8 -A$arrow1 -Gblue -W1,blue

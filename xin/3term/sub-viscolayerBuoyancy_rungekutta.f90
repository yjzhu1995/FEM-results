...
!
	...
	Yr(3,1) =  12.d0*kappa*mu/beta/rr/rr-4.d0*Cg/rr+xi1
...
! 			Yrs2 = Yr1/maxval(zabs(Yr1))
	...
	do k=1,ns
! 		d(1,k) = (Yrs2(1,k)*Yrs(2,1)-Yrs2(2,k)*Yrs(1,1))/Yrs(2,1)
